...
print("\nconfusion matrix :- \n",c)
print('Accuracy of MLPNN=',round(Acc*100,4),'%')
print('Sensitivity of MLPNN=',round(sens*100,4),'%')
print('Error of MLPNN=',round(error*100,4),'%')
print('Prediction of MLPNN=',round(prediction*100,4),'%')
