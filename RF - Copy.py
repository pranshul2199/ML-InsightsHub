...
print("\nconfusion matrix :- \n",c)
print('Accuracy of RF=',round(Acc*100,4),'%')
print('Sensitivity of RF=',round(sens*100,4),'%')
print('Error of RF=',round(error*100,4),'%')
print('Prediction of RF=',round(prediction*100,4),'%')
